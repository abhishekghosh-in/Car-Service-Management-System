  ...
  <body>
    ...
    <div class="main-container">
      ...
      <div class="container mt-3">
        <h4>Vendors supplying a particular item</h4>
        
        <form action="/seproject/dir/q6.php" method="post">
      ...
      <?php
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST') {
          ...
          // SQL query
          $sql = "SELECT * FROM vendor INNER JOIN supplied_by ON vendor.vendor_id=supplied_by.vendor_id WHERE supplied_by.item_id='$item_id';";
          $result = mysqli_query($conn, $sql);
          // number of rows
          $num = mysqli_num_rows($result);
